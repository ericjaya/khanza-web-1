    ...
    <?php foreach ($reseppulang_data as $i => $reseppulang) : ?>
        ...
        <tr>
            <td class="h-px w-64 whitespace-nowrap">
                <div class="px-6 py-3">
                    <a data-nomor-reg="<?= $reseppulang['no_rawat'] ?>"
                    data-hs-overlay="#hs-vertically-centered-scrollable-modal-<?= $reseppulang['no_rawat'] ?>" class="text-center block text-sm font-semibold text-gray-800 cursor-pointer dark:text-gray-200 hover:underline">
                        <?= $reseppulang['no_rawat'] ?>
                    </a>
                </div>
            </td>
                ...
                <div class="px-3 py-1.5 text-center inline-flex">
                    ...
                    <button
                                            ...
                                            <div class="px-3 py-1.5">
                                                ...
                                                <div id="modelConfirm-<?= $reseppulang['no_rawat'] . '-' . $i ?>" class="fixed hidden z-[70] inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 ">
                                                    <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">

                                                        <div class="flex justify-end p-2">
                                                            <button onclick="closeModal('modelConfirm-<?= $reseppulang['no_rawat'] ?>')" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
                                                        ...
                                                        <div class="p-6 pt-0 text-center">
                                                            ...
                                                            <h3 class="text-xl text-wrap font-normal text-gray-500 mt-5 mb-6">Apakah anda yakin
                                                                ...
                                                                <form action="<?= base_url('reseppulang/hapus/' . $reseppulang['no_rawat'] . '/' . $reseppulang['kode_brng'] . '/' . $reseppulang['tanggal'] . '/' . $reseppulang['jam']) ?>" method="post">
                                                                <?= csrf_field() ?>
                                                                <div class="w-full sm:flex justify-center">
                                                                    <input type="hidden" name="_method" value="DELETE">
                                                                    <button onclick="closeModal('modelConfirm-<?= $reseppulang['no_rawat'] . '-' . $i ?>')" class="w-full text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center justify-center px-3 py-2.5 text-center mr-2">Hapus</button>
                                                                    <a href="#" onclick="closeModal('modelConfirm-<?= $reseppulang['no_rawat'] . '-' . $i ?>')" class="w-full text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-cyan-200 border border-gray-200 font-medium inline-flex items-center justify-center rounded-lg text-base px-3 py-2.5 text-center" data-modal-toggle="delete-user-modal">Batal</a>
                                                                </div>
                                                            </form>
                                                        </div>
